import { FACEBOOK_INK, INSTEGRAM_LINK, TWITTER_LINK } from "../../../../config/config.service.js"
...
export const emailTemplate = ({code,title }={}) => {
    return `<!DOCTYPE html>
                ...
                <a href="${FACEBOOK_INK}" style="text-decoration: none;"><span class="twit" style="padding:10px 9px;color:#fff;border-radius:50%;">
